...
class Palette {
  // ignore: Dark
  static const MaterialColor color = MaterialColor(_colorPrimaryValue, <int, Color>{
    50: Color(0xFFEEF0FF),
  ...
  static const MaterialColor colorWhite = MaterialColor(_colorWhiteValue, <int, Color>{
  ...
  static const MaterialColor colorGray = MaterialColor(_colorGrayValue, <int, Color>{
  ...
  static const MaterialColor colorRed = MaterialColor(_colorRedValue, <int, Color>{
